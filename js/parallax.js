...
$(document).ready(function () {
    ...
    function Move() {
        ...
        if ($bg1.hasClass("inview")) {
            bg1.css({'backgroundPosition': newPos(50, windowHeight, pos, 1600, 0.4)});
        }
        ...
        if ($bg4.hasClass("inview")) {
            bg4.css({'backgroundPosition': newPos(50, windowHeight, pos, 0, -0.3)});
        }
        if ($bg5.hasClass("inview")) {
            bg5.css({'backgroundPosition': newPos(50, windowHeight, pos, 1600, 0.2)});
        }
